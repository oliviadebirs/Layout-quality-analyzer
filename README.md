...
**Layout Quality Analyzer** — это интеллектуальная система для автоматической классификации HTML-макетов (веб-страниц, презентаций, email-шаблонов) на категории **«хорошие»** и **«плохие»**.
